...
namespace FN {
	...
	static BOOL ProcessEvent(uintptr_t address, void* fnobject, void* parms)
	{
		...
		auto fProcessEvent = static_cast<void(*)(void* address, void* fnobject, void* parms)>(index[0x44]); if (!fProcessEvent) return FALSE;
...
public:
	...
	AFortWeapon* CurrentWeapon() {
		if (!utils::IsValidPointer((uintptr_t)this)) return 0;
		return (AFortWeapon*)(*(uintptr_t*)&this[0x610]);
	}
	...
	VOID SetReviveFromDBNOTime(float value) {
		if (!utils::IsValidPointer((uintptr_t)this)) return;
		*(float*)&this[0x3600] = value;
	}

	VOID SetbADSWhileNotOnGround(bool value) {
		if (!utils::IsValidPointer((uintptr_t)this)) return;
		*(bool*)&this[0x3CF1] = value;
	}


	BOOL IsDBNO() {
		if (!utils::IsValidPointer((uintptr_t)this)) return 0;
		return *(bool*)&this[0x58E];
	}

	BOOL IsDying() {
		if (!utils::IsValidPointer((uintptr_t)this)) return 0;
		return *(bool*)&this[0x540];
	}
...
public:
	...
	{
		if (!utils::IsValidPointer((uintptr_t)this)) return 0;
		auto fGetFOVAngle = reinterpret_cast<float(*)(UINT64, char*)>(*(uintptr_t*)(*(uintptr_t*)this + 0x6D0));
	...
	bool GetPlayerViewPoint(Vector3* vCameraPos, Vector3* vCameraRot)
	{
		...
		if (!GetPlayerViewPoint)
		{
			...
			GetPlayerViewPoint = *(uintptr_t*)(VTable + 0x708);
...
public:
	...
	{
		if (!utils::IsValidPointer((uintptr_t)this)) return 0;
		return (AHUD*)(*(uintptr_t*)&this[0x2B0]);
	}
...
public:
	...
	UGameInstance* OwningGameInstance() {
		if (!utils::IsValidPointer((uintptr_t)this)) return 0;
		return (UGameInstance*)(*(uintptr_t*)&this[0x188]);
	}
...
VOID LoadSignatures() {
	Addresses::UWorld = utils::PatternScan(xorstr("48 8B 05 ? ? ? ? 4D 8B C2"));
	Addresses::Free = utils::PatternScan(xorstr("48 85 C9 0F 84 ? ? ? ? 53 48 83 EC 20 48 89 7C 24 30 48 8B D9 48 8B 3D ? ? ? ? 48 85 FF 0F 84 ? ? ? ? 48 8B 07 4C 8B 40 30 48 8D 05 ? ? ? ? 4C 3B C0"));
	Addresses::GetNameByIndex = utils::PatternScan(xorstr("48 89 5C 24 ? 48 89 74 24 ? 55 57 41 56 48 8D AC 24 ? ? ? ? 48 81 EC ? ? ? ? 48 8B 05 ? ? ? ? 48 33 C4 48 89 85 ? ? ? ? 45 33 F6 48 8B F2 44 39 71 04 0F 85 ? ? ? ? 8B 19 0F B7 FB E8 ? ? ? ? 8B CB 48 8D 54 24"));
	Addresses::GetBoneMatrix = utils::PatternScan(xorstr("E8 ? ? ? ? 48 8B 47 30 F3 0F 10 45"));
	Addresses::LineOfSightTo = utils::PatternScan(xorstr("E8 ? ? ? ? 48 8B 0D ? ? ? ? 33 D2 40 8A F8"));
